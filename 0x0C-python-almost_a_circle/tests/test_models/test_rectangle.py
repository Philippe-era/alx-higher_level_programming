...
class TestRectangle_stdout(unittest.TestCase):
    """Unittests for testing __str__ and show_pic methods of Rectangle class."""

    @staticmethod
    def record_stdout(rect, method):
    ...
    def test_str_method_print_width_height(self):
        rect = Rectangle(4, 6)
        record = TestRectangle_stdout.record_stdout(rect, "print")
        correct_num = "[Rectangle] ({}) 0/0 - 4/6\n".format(rect.id)
        self.assertEqual(correct_num, record.getvalue())

    def test_str_method_width_height_x(self):
        rect = Rectangle(5, 5, 1)
        correct_num = "[Rectangle] ({}) 1/0 - 5/5".format(rect.id)
        self.assertEqual(correct_num, r.__str__())

    def test_str_method_width_height_x_y(self):
        rect = Rectangle(1, 8, 2, 4)
        correct_num = "[Rectangle] ({}) 2/4 - 1/8".format(rect.id)
        self.assertEqual(correct_num, str(r))
    ...
    # Test show_pic method
    def test_show_pic_width_height(self):
        rect = Rectangle(2, 3, 0, 0, 0)
        record = TestRectangle_stdout.record_stdout(r, "capture")
        self.assertEqual("##\n##\n##\n", record.getvalue())

    def test_show_pic_width_height_x(self):
        rect = Rectangle(3, 2, 1, 0, 1)
        record = TestRectangle_stdout.record_stdout(rect, "capture")
        self.assertEqual(" ###\n ###\n", record.getvalue())

    def test_show_pic_width_height_y(self):
        rect = Rectangle(4, 5, 0, 1, 0)
        record = TestRectangle_stdout.record_stdout(rect, "capture")
        show_pic = "\n####\n####\n####\n####\n####\n"
        self.assertEqual(show_pic, record.getvalue())

    def test_show_pic_width_height_x_y(self):
        rect = Rectangle(2, 4, 3, 2, 0)
        record = TestRectangle_stdout.record_stdout(rect, "capture")
        show_pic = "\n\n   ##\n   ##\n   ##\n   ##\n"
        self.assertEqual(show_pic, record.getvalue())

    def test_show_pic_one_arg(self):
...
class TestRectangle_update_args(unittest.TestCase):
    ...
    def test_update_args_None_id(self):
        rect = Rectangle(10, 10, 10, 10, 10)
        rect.update(None)
        correct_num = "[Rectangle] ({}) 10/10 - 10/10".format(rect.id)
        self.assertEqual(correct_num, str(rect))

    def test_update_args_None_id_and_more(self):
        rect = Rectangle(10, 10, 10, 10, 10)
        rect.update(None, 4, 5, 2)
        correct_num = "[Rectangle] ({}) 2/10 - 4/5".format(rect.id)
        self.assertEqual(correct_num, str(rect))
...
class TestRectangle_update_kwargs(unittest.TestCase):
    ...
    def test_update_kwargs_None_id_and_more(self):
        ...
        correct_num = "[Rectangle] ({}) 10/9 - 10/7".format(rect.id)
        self.assertEqual(correct_num, str(rect))
...
class TestRectangle_to_dictionary(unittest.TestCase):
    ...
    def test_to_dictionary_output(self):
        ...
        correct_num = {'x': 1, 'y': 9, 'id': 5, 'height': 2, 'width': 10}
        self.assertDictEqual(correct_num, r.to_dictionary())
