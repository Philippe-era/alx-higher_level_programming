...
class TestSquare_update_kwargs(unittest.TestCase):
    ...
    def test_update_kwargs_width_setter(self):
        square_Check = Square(10, 10, 10, 10)
        square_check.update(id=89, size=8)
        self.assertEqual(8, square_check.width)

    def test_update_kwargs_height_setter(self):
        square_check = Square(10, 10, 10, 10)
        square_check.update(id=89, size=9)
        self.assertEqual(9, square_check.height)

    def test_update_kwargs_None_id(self):
        square_check = Square(10, 10, 10, 10)
        square_check.update(id=None)
        correct_num = "[Square] ({}) 10/10 - 10".format(square_check.id)
        self.assertEqual(correct_num, str(square_check))

    def test_update_kwargs_None_id_and_more(self):
        square_check = Square(10, 10, 10, 10)
        square_check.update(id=None, size=7, x=18)
        correct_num = "[Square] ({}) 18/10 - 7".format(square_check.id)
        self.assertEqual(correct, str(square_check))

    def test_update_kwargs_twice(self):
        square_check = Square(10, 10, 10, 10)
        square_check.update(id=89, x=1)
        square_check.update(y=3, x=15, size=2)
        self.assertEqual("[Square] (89) 15/3 - 2", str(square_check))

    def test_update_kwargs_invalid_size(self):
        square_check = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            squre_check.update(size="invalid")

    def test_update_kwargs_size_zero(self):
        square_check = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "width must be > 0"):
            square_check.update(size=0)

    def test_update_kwargs_size_negative(self):
        square_check = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "width must be > 0"):
            square_check.update(size=-3)

    def test_update_kwargs_invalid_x(self):
        square_check = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            square_check.update(x="invalid")

    def test_update_kwargs_x_negative(self):
        square_check = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "x must be >= 0"):
            square_check.update(x=-5)

    def test_update_kwargs_invalid_y(self):
        square_checck = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            square_check.update(y="invalid")

    def test_update_kwargs_y_negative(self):
        square_check = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "y must be >= 0"):
            square_check.update(y=-5)

    def test_update_args_and_kwargs(self):
        square_check = Square(10, 10, 10, 10)
        square_check.update(89, 2, y=6)
        self.assertEqual("[Square] (89) 10/10 - 2", str(square_check))

    def test_update_kwargs_wrong_keys(self):
        square_check = Square(10, 10, 10, 10)
        square_check.update(a=5, b=10)
        self.assertEqual("[Square] (10) 10/10 - 10", str(square_check))

    def test_update_kwargs_some_wrong_keys(self):
        square_check = Square(10, 10, 10, 10)
        square_check.update(size=5, id=89, a=1, b=54)
        self.assertEqual("[Square] (89) 10/10 - 5", str(square_check))
...
class TestSquare_to_dictionary(unittest.TestCase):
    ...
    def test_to_dictionary_output(self):
        square_check = Square(10, 2, 1, 1)
        correct_numbers = {'id': 1, 'x': 2, 'size': 10, 'y': 1}
        self.assertDictEqual(correct_numbers, square_check.to_dictionary())
